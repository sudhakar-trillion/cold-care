...
<a  class="current">
  ...
  <?PHP     
if( $this->uri->segment(1) == "admin-view-orders"){ echo ' View orders'; }
else if($this->uri->segment(1) == "admin-view-awaiting-orders") { echo "View Awaiting orders" ;}
else if($this->uri->segment(1) == "admin-view-confirmed-orders") { echo "View Confirmed orders" ;}
else if($this->uri->segment(1) == "admin-view-delivered-orders") { echo "View delivered orders" ;}
else if($this->uri->segment(1) == "admin-view-cancelled-orders") { echo "View cancelled orders" ;}
?>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-box">
         ...
         <select data-ng-options="o.Store for o in stores" class="form-control" data-ng-model="srch.Owner_Name"></select>
           ...
           <div class="col-md-2 btns-filters">
             ...
             <button type="button" class="btn btn-success" ng-click="getordersbyfilter()">Search</button>
              <button type="button" class="btn btn-warning" ng-click="download_orders_by_excelsheet()"><i class="fa fa-download" aria-hidden="true"></i> Excel</button>
              <!--
