<div id="content" ng-app="myApp">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?PHP echo base_url('admin-dashboard')?>" title="Go to dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="#">Manage users</a>
        <a href="<?PHP echo base_url('admin-add-user'); ?>">Add user</a><a  class="current">View New users</a> </div>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding" ng-controller="ecomCtrl" ng-init="getuserFranchise('new','New')">
